...
import joblib
from PyQt5.QtWidgets import QApplication, QMainWindow, QTableWidgetItem, QTableWidget, QHeaderView
...
#Save Model AI
AI_Model = "Model/Completed_model_AI.joblib"
joblib.dump(model, AI_Model)
